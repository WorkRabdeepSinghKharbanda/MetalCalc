...
export const APP_ROUTES = [
  ...
  { label: 'Gold Price Per Gram', path: '/gold-price-per-gram', group: 'Other' },
  { label: '24k vs 22k Gold', path: '/24k-vs-22k-gold-difference', group: 'Other' },
  { label: 'Best Time to Buy Gold', path: '/best-time-to-buy-gold', group: 'Other' },
  { label: 'Gold Investment for Beginners', path: '/gold-investment-for-beginners', group: 'Other' },
  { label: 'Silver Investment Guide', path: '/silver-investment-guide', group: 'Other' },
  { label: 'Crypto Diversification Guide', path: '/crypto-portfolio-diversification-guide', group: 'Other' },
  { label: 'Understanding Stock Trade Signals', path: '/understanding-stock-trade-signals', group: 'Other' },
  { label: 'Savings Goal vs Lump Sum', path: '/savings-goal-vs-lump-sum-gold', group: 'Other' },
  { label: 'Jewelry Making Charges Explained', path: '/jewelry-making-charges-explained', group: 'Other' },
  { label: 'Net Worth Tracking Guide', path: '/net-worth-tracking-guide', group: 'Other' },
